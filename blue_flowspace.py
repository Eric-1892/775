...
commands = [
    ...
    "fvctl -n add-flowspace blue25 0200000000000006 2 in_port=3,nw_src=10.0.0.11,nw_dst=10.0.0.12 blue=7",
    "fvctl -n add-flowspace blue26 0200000000000006 2 in_port=4,nw_src=10.0.0.12,nw_dst=10.0.0.9 blue=7",
    "fvctl -n add-flowspace blue27 0200000000000006 2 in_port=4,nw_src=10.0.0.12,nw_dst=10.0.0.10 blue=7",
    "fvctl -n add-flowspace blue28 0200000000000006 2 in_port=4,nw_src=10.0.0.12,nw_dst=10.0.0.11 blue=7"
]
